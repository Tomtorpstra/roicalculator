...
const translations = {
    nl: {
        ...
        perUnit: 'per eenheid',
        addedValueLabel: 'Toegevoegde marge per uur:',
        perHourSuffix: '/uur',
        ...
        calcStep1Title: '1. Toegevoegde marge per uur',
        calcStep1Formula: 'Marge per uur = Output per uur \u00d7 Marge per eenheid',
        ...
        calcStep2Formula: 'Jaarlijks = Marge/uur (bij 100%) × OEE verbetering (punten) × Werkuren × Kostenfactor',
        ...
        valuePerHourTooltipTitle: 'Marge per uur bij 100% OEE',
        valuePerHourTooltipBody: 'Dit is de maximale toegevoegde marge per uur, berekend alsof de lijn op 100% OEE draait (zonder verlies van beschikbaarheid, prestatie en kwaliteit).',
        ...
        calcBreakdownValueHr: 'Marge/uur',
    ...
    en: {
        ...
        perUnit: 'per unit',
        addedValueLabel: 'Added margin per hour:',
        perHourSuffix: '/hour',
        ...
        calcStep1Title: '1. Added margin per hour',
        calcStep1Formula: 'Margin per hour = Output per hour \u00d7 Margin per unit',
        ...
        calcStep2Formula: 'Annual = Margin/hour (at 100%) × OEE improvement (points) × Work hours × Cost factor',
        calcStep2Desc: 'Each OEE percentage point gained is directly valued against the added margin per hour. For example, if you go from 50% to 52% OEE, the model calculates with the 2% gain on your total capacity.',
        ...
        valuePerHourTooltipTitle: 'Margin per hour at 100% OEE',
        valuePerHourTooltipBody: 'This is the maximum added margin per hour, calculated as if the line runs at 100% OEE (without loss of availability, performance and quality).',
        ...
        calcBreakdownValueHr: 'Margin/hour',
        calcBreakdownModel: 'Model',
